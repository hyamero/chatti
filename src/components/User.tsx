...
export const User: React.FC<UserProps> = ({}) => {
  ...
  return (
    <div className="w-[60%] justify-between overflow-y-hidden rounded-tl-lg rounded-bl-lg bg-white/70 px-4 pb-5 backdrop-blur-xl">
      ...
      <div className="flex h-full flex-col justify-between space-y-3 pb-10">
